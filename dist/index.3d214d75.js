...
var _actionsJs = require("./modules/actions.js");
var _luxon = require("luxon");
var _elementsJs = require("./modules/elements.js");
window.onload = ()=>{
    const now = (0, _luxon.DateTime).now();
    (0, _elementsJs.todayDate).innerHTML = now.toLocaleString((0, _luxon.DateTime).DATETIME_MED_WITH_SECONDS);
};
setInterval(()=>{
    const now = (0, _luxon.DateTime).now();
    const date = now.toLocaleString((0, _luxon.DateTime).DATETIME_MED_WITH_SECONDS);
    (0, _elementsJs.todayDate).innerHTML = date;
}, 1000);

},{"./modules/actions.js":"2IElR","luxon":"dpK6X","./modules/elements.js":"5gnsZ"}],"2IElR":[function(require,module,exports) {
var _elementsJs = require("./elements.js");
var _objectsJs = require("./objects.js");
_elementsJs.form.addEventListener("submit", (e)=>{
    e.preventDefault();
    (0, _objectsJs.books).submitbtn();
});
_elementsJs.bookList.addEventListener("click", ({ target })=>{
    if (target.classList.contains("btn-remove")) {
        const { index } = target.dataset;
        (0, _objectsJs.books).removeBook(index);
    }
});
_elementsJs.menuItems.forEach((item)=>{
    const itemID = item.id;
    item.addEventListener("click", ()=>{
        _elementsJs.contentItems.forEach((content)=>{
            const contentId = content.id;
            if (contentId.includes(itemID)) content.classList.remove("hide");
            else content.classList.add("hide");
        });
    });
});

},{"./elements.js":"5gnsZ","./objects.js":"d5qus"}],"5gnsZ":[function(require,module,exports) {
/* Form Items */ var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "form", ()=>form);
parcelHelpers.export(exports, "bookList", ()=>bookList);
parcelHelpers.export(exports, "menuItems", ()=>menuItems);
parcelHelpers.export(exports, "contentItems", ()=>contentItems);
parcelHelpers.export(exports, "todayDate", ()=>todayDate);
const form = document.querySelector("form");
const bookList = document.getElementById("bookList");
/* Navigation Bar Links */ const menuItems = Array.from(document.querySelectorAll(".menu-item"));
const contentItems = Array.from(document.querySelectorAll(".content"));
/* Date Items */ const todayDate = document.querySelector("#today-date");
...
},{}],"d5qus":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "books", ()=>books);
var _classesJs = require("./classes.js");
/* Books Collection Object */ const books = new (0, _classesJs.Books)();
books.displayBooks();

},{"./classes.js":"dhx1O","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"dhx1O":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "Books", ()=>Books);
var _elementsJs = require("./elements.js");
    ...
    constructor(){
        ...
        this.displayBooks = ()=>{
            ...
            if (storedBooks) {
                ...
                (0, _elementsJs.bookList).className = "bookList";
                (0, _elementsJs.bookList).innerHTML = this.books.map((book, index)=>`
        <li class="lineBook">
...
},{"./elements.js":"5gnsZ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"dpK6X":[function(require,module,exports) {
"use strict";
...
},{}]},["2UeK4","bB7Pu"], "bB7Pu", "parcelRequirec0f2")
